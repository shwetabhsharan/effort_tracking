...
from administration.models import (UserProfile, Sprint, Task, SubTask, CodeReview, EffortRecord, EffortTracking,
                                   GlobalConfig, Keyword, TagTaskMap)

class UserProfileAdmin(admin.ModelAdmin):
    list_display = ('user', 'user_role', 'team', 'is_client')
    search_fields = ('user', 'user_role', 'team', 'is_client')
...
class TagTaskMapAdmin(admin.ModelAdmin):
    list_display = ('task', 'keyword')
admin.site.register(TagTaskMap, TagTaskMapAdmin)
